...
if ! "$IMTOOL_AOS" "$INPUT_DIR/deer-small-100.ppm" "$OUTPUT_DIR/deer-small-1000.ppm" resize 1000 1000; then
...
if ! "$IMTOOL_AOS" "$INPUT_DIR/deer-large-1000.ppm" "$OUTPUT_DIR/deer-large-100.ppm" resize 100 100; then
